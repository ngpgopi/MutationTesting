...
public class TraceFileComparator {
    ...
    static void hashCodeComparator() throws IOException {
        try {
            ...
            BufferedReader br1 = new BufferedReader(new FileReader("TraceFile.txt"));
            BufferedReader br2 = new BufferedReader(new FileReader("MutatedTraceFile.txt"));
            if (counter == 0)
                initializeTrace();
            System.setOut(out);
