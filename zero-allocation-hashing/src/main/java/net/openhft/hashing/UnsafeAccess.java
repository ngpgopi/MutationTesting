...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 42 + " | " + "BOOLEAN_BASE = UNSAFE.arrayBaseOffset(boolean[].class);" + " | " + "src\\main\\java\\net" + " | " + " ASSIGNMENT " + " | " +  " static final sun.misc.Unsafe UNSAFE = " + UNSAFE + " | " +  " static final long BOOLEAN_BASE = " + BOOLEAN_BASE);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 45 + " | " + "BYTE_BASE = UNSAFE.arrayBaseOffset(byte[].class);" + " | " + "src\\main\\java\\net" + " | " + " ASSIGNMENT " + " | " +  " static final long BYTE_BASE = " + BYTE_BASE + " | " +  " static final sun.misc.Unsafe UNSAFE = " + UNSAFE);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 48 + " | " + "CHAR_BASE = UNSAFE.arrayBaseOffset(char[].class);" + " | " + "src\\main\\java\\net" + " | " + " ASSIGNMENT " + " | " +  " static final long CHAR_BASE = " + CHAR_BASE + " | " +  " static final sun.misc.Unsafe UNSAFE = " + UNSAFE);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 51 + " | " + "SHORT_BASE = UNSAFE.arrayBaseOffset(short[].class);" + " | " + "src\\main\\java\\net" + " | " + " ASSIGNMENT " + " | " +  " static final sun.misc.Unsafe UNSAFE = " + UNSAFE + " | " +  " static final long SHORT_BASE = " + SHORT_BASE);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 54 + " | " + "INT_BASE = UNSAFE.arrayBaseOffset(int[].class);" + " | " + "src\\main\\java\\net" + " | " + " ASSIGNMENT " + " | " +  " static final sun.misc.Unsafe UNSAFE = " + UNSAFE + " | " +  " static final long INT_BASE = " + INT_BASE);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 57 + " | " + "LONG_BASE = UNSAFE.arrayBaseOffset(long[].class);" + " | " + "src\\main\\java\\net" + " | " + " ASSIGNMENT " + " | " +  " static final long LONG_BASE = " + LONG_BASE + " | " +  " static final sun.misc.Unsafe UNSAFE = " + UNSAFE);
